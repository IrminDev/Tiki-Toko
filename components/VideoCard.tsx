...
const VideoCard: NextPage<IProps> = ({post}) => { //Other way to declare our props but is recomended with complex types

const [isHover, setisHover] = useState(false)
const [playing, setplaying] = useState(false)
const [isVideoMuted, setisVideoMuted] = useState(false)

const videoRef = useRef<HTMLVideoElement>(null) //Like document getElementById in plain HTML
const onVideoPress = () => {
    if(playing){
